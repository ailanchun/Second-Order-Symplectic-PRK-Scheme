...
sig(1:nx,z1nz:nz)=0.02;

epp(1:nx,z2nz:nz)=3;
ep(1:nx,z2nz:nz)=16;
mu(1:nx,z2nz:nz)=1;
chiyu(1:nx,z2nz:nz)=1e-13;
sig(1:nx,z2nz:nz)=0.002;

epp(1:nx,z3nz:nz)=5;
ep(1:nx,z3nz:nz)=30;
mu(1:nx,z3nz:nz)=1;
chiyu(1:nx,z3nz:nz)=1e-12;
sig(1:nx,z3nz:nz)=0.003;
...
gather = zeros(fix((numit-1)/outstep)+1,nrec,nsrc);%fix朝零方向取整，如fix(-1.3)=-1; fix(1.3)=1;
